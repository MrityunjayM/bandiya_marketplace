...
const Pricing = () => {
  ...
  return (
    <section id="pricing" sx={styles.section}>
      <Container>
        <SectionHeading sx={{ mb: [6, null, null, 14] }} slogan="Deal for your business" title="Meet our pricing plan that suit you" />
        <Box sx={styles.grid}>
          {isTablet && (
...
const styles = {
  ...
  features: {
    pl: 0,
    transform: [null, null, null, null, "translateY(-10px)", "translateY(-23px)"],
    li: {
      display: "flex",
      alignItems: "center",
      fontWeight: 500,
